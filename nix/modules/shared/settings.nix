...
in {
  options = with types; {
    my = {
      name = mkOptStr "Isaac Dadzie";
      timezone = mkOptStr "Africa/Accra";
      username = mkOptStr "user";
      website = mkOptStr "https://ike.codes";
      github_username = mkOptStr "idadzie";
      email = mkOptStr "hello@ike.codes";
      terminal = mkOptStr "kitty";
      nix_managed =
        mkOptStr
        "vim: set nomodifiable : Nix managed - DO NOT EDIT - see source inside ~/Code/github.com/idadzie/dotfiles or use `:set modifiable` to force.";
  ...
  config = {
    ...
    #
    #   my.hm.file        ->  home-manager.users.user.home.file
    #   my.hm.configFile  ->  home-manager.users.user.home.xdg.configFile
    #   my.hm.dataFile    ->  home-manager.users.user.home.xdg.dataFile
